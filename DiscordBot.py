...
class DiscordBot(discord.Client):
    def __init__(self, screenshot_prefix: str, decklink_prefix: str, deckroll_deck_prefix: str, card_pool_standard: CardPool, card_pool_eternal: CardPool, format_default: Literal["standard", "eternal"], language_default: str, amount_regions_default: int, amount_cards_default: int, amount_champions_default: int, regions_and_weights_default: Dict[str, int], cards_and_weights_standard_default: Dict[str, int], cards_and_weights_eternal_default: Dict[str, int], count_chances_default: Dict[str, int], count_chances_two_remaining_deck_slots_default: Dict[str, int]) -> None:
        # Prefixes
